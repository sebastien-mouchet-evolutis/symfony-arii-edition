...
class RuntimesController extends Controller {
    ...
    public function ordersAction()
    {
        ...
        $qry .= $sql->From(array('JOC_ORDER_STEP_RUNTIMES fosr'));
        $qry .= $sql->LeftJoin('JOC_ORDER_RUNTIMES fore',array('fosr.ORDER_ID','fore.ORDER_ID'));
        $qry .= $sql->LeftJoin('JOC_ORDERS fo',array('fosr.ORDER_ID','fo.ID'));
        $qry .= $sql->LeftJoin('JOC_JOB_CHAIN_NODES fjcn',array('fosr.JOB_CHAIN_NODE_ID','fjcn.ID'));
        $qry .= $sql->LeftJoin('JOC_SPOOLERS fs',array('fo.SPOOLER_ID','fs.ID'));
