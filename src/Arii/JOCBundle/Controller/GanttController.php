...
class GanttController extends Controller
{
    ...
    public function ordersAction() {
        ...
        $qry = $sql->Select(array('o.ID as ID_ORDER','o.PATH as ORDER_PATH','o.NAME as ORDER_ID','o.START_TIME as ORDER_START','o.SUSPENDED',
                ...
                .$sql->LeftJoin('JOC_JOB_CHAINS jc',array('o.JOB_CHAIN_ID','jc.ID'))
                .$sql->LeftJoin('JOC_SPOOLERS s',array('o.SPOOLER_ID','s.ID'))
                .$sql->LeftJoin('JOC_ORDER_RUNTIMES runs',array('o.ID','runs.ORDER_ID'))
                .$sql->LeftJoin('JOC_ORDER_STEP_RUNTIMES sruns',array('o.ID','sruns.ORDER_ID'))
                .$sql->Where($Fields);
        ...
        $qry = $sql->Select(array('distinct o.ID as ID_ORDER','o.PATH as ORDER_PATH','o.NAME as ORDER_ID','o.TITLE','o.START_TIME as ORDER_START',
                ...
                .$sql->From(array('JOC_ORDERS o'))
                .$sql->LeftJoin('JOC_JOB_CHAINS jc',array('o.JOB_CHAIN_ID','jc.id'))
                .$sql->LeftJoin('JOC_JOB_CHAIN_NODES jcn',array('jc.ID','jcn.JOB_CHAIN_ID'))
                .$sql->LeftJoin('JOC_JOBS j',array('jcn.JOB_ID','j.ID'))
                .$sql->LeftJoin('JOC_SPOOLERS s',array('o.SPOOLER_ID','s.ID'))
                .$sql->Where($Fields)
