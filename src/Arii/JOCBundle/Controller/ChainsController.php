...
class ChainsController extends Controller
{
    ...
    public function list_xmlAction()
    {
        ...
        $qry = $sql->Select(array( 
                ...
                .$sql->LeftJoin('JOC_JOB_CHAINS fjc',array('fjc.id','fjcn.job_chain_id'))
                .$sql->LeftJoin('JOC_SPOOLERS fs',array('fjc.spooler_id','fs.id'))     
                .$sql->LeftJoin('JOC_JOBS fj',array('fjcn.job_id','fj.id'))
                .$sql->LeftJoin('JOC_ORDERS fo',array('fjcn.id','fo.job_chain_node_id'))
                .$sql->LeftJoin('JOC_FILE_ORDERS ff',array('fjc.id','ff.job_chain_id'))
                .$sql->Where( $Fields )
