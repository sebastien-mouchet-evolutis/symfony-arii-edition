   ...
   public function grid_toolbarAction()
    ...
    public function list_xmlAction()
    {
        ...
        $qry = $sql->Select(array( 'fo.ID as ORDER_ID','fo.NAME as ORDER_NAME','fo.START_TIME as ORDER_START','fo.NEXT_START_TIME','fo.TITLE as ORDER_TITLE','fo.STATE as ORDER_STATE',
                    ...
                    'fs.id as SPOOLER_ID','fs.NAME as SPOOLER_NAME', 
                    'fjcn.STATE', 
                ...
                .$sql->LeftJoin('JOC_ORDER_STATUS status',array('fo.ID','status.ORDER_ID'))
                .$sql->LeftJoin('JOC_JOB_CHAINS fc',array('fo.JOB_CHAIN_ID','fc.ID'))
                .$sql->LeftJoin('JOC_JOB_CHAIN_NODES fjcn',array('fo.JOB_CHAIN_NODE_ID','fjcn.ID'))
                .$sql->LeftJoin('JOC_JOBS fj',array('fjcn.JOB_ID','fj.ID'))
                .$sql->LeftJoin('JOC_JOB_CHAINS fjc',array('fjcn.JOB_CHAIN_ID','fjc.ID'))                
                .$sql->LeftJoin('JOC_SPOOLERS fs',array('fo.SPOOLER_ID','fs.id'))
