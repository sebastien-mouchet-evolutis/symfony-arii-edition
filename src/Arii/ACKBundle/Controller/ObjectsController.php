...
class ObjectsController extends Controller{
    ...
    public function gridAction()
    {
        ...
        $Errors = $this->getDoctrine()->getRepository('AriiACKBundle:Object')->findHosts();
        $render = $this->container->get('arii_core.render');     
        return $render->grid($Errors,'name,description');
    }
...
*/
        list($Alarm) = $this->getDoctrine()->getRepository("AriiACKBundle:Object")->Alarm($id);      
