...
class AlarmsController extends Controller{
    ...
    {
        return $this->render('AriiACKBundle:Alarms:index.html.twig');
    }
    ...
    public function toolbarAction()
    {
        ...
        return $this->render("AriiACKBundle:Alarms:toolbar.xml.twig", array(), $response);
    }
    ...
    public function grid_menuAction()
    {
        $response = new Response();
        $response->headers->set('Content-Type', 'text/xml');
        return $this->render('AriiACKBundle:Alarms:grid_menu.xml.twig',array(), $response );
    }
    ...
    public function gridAction()
    {
        ...
        $Errors = $this->getDoctrine()->getRepository('AriiACKBundle:Alarm')->listState($state);
...
*/
        list($Alarm) = $this->getDoctrine()->getRepository("AriiACKBundle:Alarm")->Alarm($id);      
