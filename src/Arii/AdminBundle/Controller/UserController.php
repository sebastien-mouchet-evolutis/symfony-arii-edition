...
class UserController extends Controller {
    ...
    public function userAction(){
        ...
        return $this->render("AriiAdminBundle:User:user.html.twig");
    }
   ...
   public function formAction()
    {   
        ...
        $form->render_table("ARII_USER","id","id,username,email,first_name,last_name,team_id,roles");  
    }
    ...
    function user_render ($data){
        ...
        if (($b = strpos($roles,'"'))>0) {
            $b += 1;
            $e = strpos($roles,'"',$b);
            $data->set_value('roles',str_replace('ROLE_','',substr($roles,$b,$e-$b)));
        }
        else {
            $data->set_value('roles','');
        }
    }
