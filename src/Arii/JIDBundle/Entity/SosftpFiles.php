 ...
 * SosftpFiles
 *
 * @ORM\Table(name="sosftp_files", uniqueConstraints={@ORM\UniqueConstraint(name="MANDATOR", columns={"MANDATOR", "SOURCE_HOST", "SOURCE_HOST_IP", "SOURCE_DIR", "SOURCE_FILENAME", "SOURCE_USER", "MD5"})})
