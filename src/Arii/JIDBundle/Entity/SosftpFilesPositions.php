...
/**
 * SosftpFilesPositions
 *
 * @ORM\Table(name="sosftp_files_positions", uniqueConstraints={@ORM\UniqueConstraint(name="LOCAL_FILENAME", columns={"LOCAL_FILENAME"})})
 * @ORM\Entity(readOnly=true)
 */
class SosftpFilesPositions
{
    /**
     * @var string
     *
