...
class PartnersController extends Controller
{
    ...
    {
       return $this->render('AriiMFTBundle:Partners:index.html.twig');
    }
    ...
    public function toolbarAction()
    {
        ...
        return $this->render('AriiMFTBundle:Partners:toolbar.xml.twig',array(), $response );
    }
    ...
    {        
        $response = new Response();
        $response->headers->set('Content-Type', 'text/xml');    
        return $this->render('AriiMFTBundle:Partners:grid_menu.xml.twig',array(), $response );
    }
